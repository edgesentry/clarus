...
edgesentry-rs   Domain-agnostic Rust library + eds CLI.
                ...
                No business logic — consumed by application repos via Cargo path deps.
...
documaris       Operator-facing UI and compliance document platform.
                Reads attested data from clarus (browser-side, zero server cost).
                Generates compliance documents (FAL forms, BCA Green Mark reports).
                Does not own proof data or run verification infrastructure.
```
